      ...
      <nav className="bg-solarSystem-background bg-cover bg-no-repeat bg-center fixed w-full z-20 top-0 left-0 h-25 text-white">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <div className=" flex flex-row w-full " id="navbar-sticky">
            <ul className="flex flex-col md:flex-row p-4 md:p-0 mt-4 text-xl border border-gray-100 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
